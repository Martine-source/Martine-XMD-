const {
  ...
  const ownerNumber = ['254759210821']
...
const whatsappChannelLink = "https://whatsapp.com/channel/0029VasHgfG4tRrwjAUyTs10";
  ...
  try {
    ...
    console.log("📬 Followed Martine-XMD newsletter.");
  } catch (e) {
...
├─ 🛠️ *Martine-XMD Developer:*
│   Click [**Here**](https://wa.me/254759210821)
├─ ⭐ *Give Us a Star:*
│   Star Us [**Here**](https://github.com/Black-Tappy/Shadow-Xtech-V1) !
╰─🛠️ *Prefix:* \`${prefix}\`

> _© *Powered By Martine-XMD*_`;
    ...
    await conn.sendMessage(conn.user.id, {
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: "ᴍᴀʀᴛɪɴᴇ-xᴍᴅ",
                serverMessageId: -1,
            },
            externalAdReply: { // Define the new externalAdReply inline
                title: "Martine-XMD Bot",
                body: "Powered By Martine-XMD",
...
// --- NEW: Keep-Alive Endpoint ---
  app.get("/keep-alive", (req, res) => {
      res.json({
          status: "alive",
          message: "[🟢] Martine-XMD is running.",

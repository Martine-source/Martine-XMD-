...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY MARTINE-XMD🩷*",
...
BOT_NAME: process.env.BOT_NAME || "MARTINE-XMD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "MARTINE-XMD",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254759210821",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "Martine-XMD",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© Powered By Martine-XMD*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/og4tsk.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> AM ACTIVE *MARTINE-XMD*⚡",
// add alive msg here 
...
DEV: process.env.DEV || "254759210821",
